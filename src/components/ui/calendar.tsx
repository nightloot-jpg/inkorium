  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: "h-8 w-8 p-0 font-normal aria-selected:opacity-100 rounded-md hover:bg-secondary transition-colors cursor-pointer flex items-center justify-center",
        day_selected:
          "bg-[#2F5FA7] text-white hover:bg-[#2F5FA7] hover:text-white focus:bg-[#2F5FA7] focus:text-white font-bold",
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="h-4 w-4 text-[#2F5FA7]" />,
        IconRight: ({ ...props }) => <ChevronRight className="h-4 w-4 text-[#2F5FA7]" />,
      }}
      {...props}
    />
  );
